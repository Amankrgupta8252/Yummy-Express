    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          GestureDetector(
            onTap: () {
              // Navigate to the desired page when the CircleAvatar is tapped
              Navigator.push(
                context,
      ...
      bottomNavigationBar: BottomNavigationBar(
        currentIndex: 0, // or use a state to track index
        selectedItemColor: const Color.fromARGB(255, 40, 198, 193),
        unselectedItemColor: const Color.fromARGB(168, 73, 69, 69),
        ...
        onTap: (index) {
          // Logic to navigate between pages based on index
          if (index == 0) {
            Navigator.push(
...
class PopularItemsGrid extends StatelessWidget {
  final List<Map<String, dynamic>> items = [
    ...
    },
    {
      ...
      'ret': '4.2',
      'icon': Icons.star,
      'image': 'assets/chholaBhatora.png'
    },
    {
      'name': 'Pizza',
      'price': '150',
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        return PopularItemCard(
          ...
          ret: items[index]['ret']!, // Pass the actual rating value
        );
      },
    );
  }
...
class PopularItemCard extends StatelessWidget {
  ...
  const PopularItemCard({
    ...
    required this.image,
    required this.icon,
    required this.ret, // Accept rating in constructor
  });
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        ret, // Display the rating instead of hardcoded "ret"
                        style: const TextStyle(
                          fontSize: 12,
